  ...
  return (
    <section class="bg-white">
      <div class="container px-[1rem] py-8">
        <h2 class="text-xl md:text-3xl font-bold text-black mb-4">
          {titleSection}
        </h2>
        <p class="text-md font-base text-black mb-8">{subTitleSection}</p>
        <div class="flex justify-between items-center mb-8 gap-4">
          <div class="flex gap-4 overflow-auto">
            <p class="border border-[#00a59a] py-1 px-4 rounded-full text-white bg-[#00a59a] font-bold whitespace-nowrap">
              Graduação
            </p>
            <p class="border border-[#00a59a] py-1 px-4 rounded-full text-[#00a59a] font-bold whitespace-nowrap">
              Pós-Graduação
            </p>
            <p class="border border-[#00a59a] py-1 px-4 rounded-full text-[#00a59a] font-bold whitespace-nowrap">
          ...
          <a href={link} class="hidden md:flex items-center gap-3">
            <p class="text-lg text-[#00a59a] font-bold whitespace-nowrap">
              Ver mais cursos
            </p>
            <svg
        ...
        <div class="flex md:grid md:grid-cols-2 lg:grid-cols-4 overflow-x-auto md:overflow-x-visible gap-5 py-4">
          <div class="min-w-[320px] md:min-w-0 relative rounded-md h-[350px] flex flex-wrap content-between flex-row overflow-hidden bg-no-repeat bg-center hover:scale-y-[106%] group hover:scale-x-[105%] hover:border border-black duration-300">
            <div>
              ...
              <p class="z-10 bg-[#fd0] text-black py-1 px-2 rounded-full mt-5 ml-5 text-xs font-bold z-10 relative">
                Graduação
              </p>
            </div>
        ...
        <a href={link} class="flex md:hidden items-center gap-3">
          <p class="text-md md:text-lg text-[#00a59a] font-light whitespace-nowrap">
            Ver mais cursos
          </p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
