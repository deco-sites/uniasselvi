        ...
        <section class="bg-[#fd0] hidden md:block">
            <div class="container px-[1rem] pt-[64px]">
                <div class="flex flex-col md:flex-row gap-5 py-10">
                    ...
                    <div class="basis-1/2">
                        <h2 class="text-xl text-black font-bold ">ESTUDO GARANTIDO: caso você perca o emprego no início do curso, as mensalidades do primeiro semestre serão por conta da UNIASSELVI.</h2>
                        <h3 class="text-xl text-black font-bold">Estude em casa ou no polo com tutor exclusivo por turma.</h3>
                    </div>
                </div>
            </div>
        </section>
