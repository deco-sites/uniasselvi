            ...
            <div class="container px-[1rem] pt-[64px] pb-[50px]">
                ...
                <div class="flex flex-col md:flex-row gap-[24px]">
                    ...
                    <div class="basis-full md:basis-1/2 md:order-1">
                        ...
                        <p class="text-2xl text-black font-bold">Duração: <span class="font-base">{semestre} semestres</span></p>
                        <div class="flex md:grid md:grid-cols-4 overflow-x-auto md:overflow-x-visible gap-4 mt-6">
                            <div class="min-w-[100px] md:min-w-0">
                                ...
                                <p class="text-md font-base text-black">Mais de <strong>500 mil alunos</strong> matriculados</p>
                            </div>
                            <div class="min-w-[100px] md:min-w-0">
                                {icon_2 && (
                                    <Image
                                ...
                                <p class="text-md font-base text-black">Tutor <strong>exclusivo</strong> por turma</p>
                            </div>
                            <div class="min-w-[100px] md:min-w-0">
                                {icon_3 && (
                                    <Image
                                ...
                                <p class="text-md font-base text-black">Aplicativo com <strong>navegação gratuita</strong></p>
                            </div>
                            <div class="min-w-[100px] md:min-w-0">
                                {icon_4 && (
                                    <Image
                                ...
                                <p class="text-md font-base text-black">Mensalidades que <strong>cabem no seu bolso</strong></p>
                            </div>
                        </div>
                        <div class="flex gap-[12px] mt-10">
                            ...
                            <div class="text-md md:text-2xl text-black font-base" dangerouslySetInnerHTML={{
                                __html: text_4,
                            }}></div>
                        </div>
                        <div class="flex gap-[12px] mt-10">
