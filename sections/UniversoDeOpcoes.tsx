    ...
    return (
        <section class="bg-white py-8">
            <div class="container px-[1rem]">
                <h2 class="text-3xl font-bold text-black mb-4">Um universo de opções para sua evolução</h2>
                <p class="text-md font-base text-black mb-8">Vale o que custa e não pesa no bolso!</p>
                <div class="grid md:grid-cols-2 gap-8">
                    <a href="/graduacao" class="bg-[#f9f9f9] flex items-center gap-4 p-4">
                        ...
                        <div class="flex-1">
                            <p class="text-[13px] text-black">Graduação</p>
                            <p class="text-[13px] text-black">A partir de <strong class="text-[14px]">R$ 99,00 mensais</strong></p>
                        </div>
                        <div>
                    ...
                    <a href="#" class="bg-[#f9f9f9] flex items-center gap-4 p-4">
                        ...
                        <div class="flex-1">
                            <p class="text-[13px] text-black">Pós-Graduação</p>
                            <p class="text-[13px] text-black">A partir de <strong class="text-[14px]">R$ 71,91 mensais</strong></p>
                        </div>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="17px" height="20px" viewBox="0 0 320 512"><path stroke="#000000" d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>
                        </div>
                    ...
                    <a href="#" class="bg-[#f9f9f9] flex items-center gap-4 p-4">
                        ...
                        <div class="flex-1">
                            <p class="text-[13px] text-black">Técnicos / Profissionalizantes</p>
                            <p class="text-[13px] text-black">A partir de <strong class="text-[14px]">R$ 98,18 mensais</strong></p>
                        </div>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="17px" height="20px" viewBox="0 0 320 512"><path stroke="#000000" d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>
                        </div>
                    ...
                    <a href="#" class="bg-[#f9f9f9] flex items-center gap-4 p-4">
                        ...
                        <div class="flex-1">
                            <p class="text-[13px] text-black">Cursos Livres</p>
                            <p class="text-[13px] text-black"><strong class="text-[14px]">Gratuitos</strong> e a partir de <strong class="text-[14px]">R$ 40,00 mensais</strong></p>
                        </div>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="17px" height="20px" viewBox="0 0 320 512"><path stroke="#000000" d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>
                        </div>
