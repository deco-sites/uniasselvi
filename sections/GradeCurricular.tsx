            ...
            <div class="bg-[#ebebeb] rounded-[3px] shadow-[0_3px_10px_rgba(65,65,65,.25)]">
              <div class="flex">
                <div class="flex-1 text-center py-3 px-2">
                  <p class="text-black font-base text-xl">
                    Mercado de Trabalho
                  </p>
                </div>
                <button
                  class="flex-1 text-center py-3 px-2 bg-gradient-to-b from-[#d5d5d5] to-[#b9b9b9] text-black font-base text-xl"
                  onclick={() =>
              ...
              <div class="py-[70px] px-[40px]">
                <p class="text-3xl text-black font-bold">
                  Inscreva-se agora e dê o primeiro passo em direção aos seus
                  sonhos.
                </p>
                <div class="flex items-center gap-[20px] mt-10">
                  <div>
                    <svg
                      ...
                      height="44px"
                      width="50px"
                      viewBox="0 0 49.99 43.02"
                    >
                      <g id="Layer_2" data-name="Layer 2">
                        <g id="Layer_1-2" data-name="Layer 1">
                          <path
                            fill="#00a499"
                            d="M5.35,17.71c4.84,4.13,11.89,10.44,11.89,10.44S33.46,9.15,48.81,0L50,3.19C44.42,6.71,27.55,26,20.95,43c0,0-17.6-17.27-20.95-21.21l5.35-4.1Z"
                          />
                        </g>
                      </g>
                    </svg>
                  </div>
                  <p class="text-2xl font-base text-black">
                    Resolução de Autorização nº 023-I/2010
                  </p>
                </div>
                <div class="flex items-center gap-[20px] mt-10">
                  <div>
                  ...
                  <p class="text-2xl font-base text-black">
                    <strong>Mesma validade e peso</strong>{" "}
                    que uma graduação presencial
                  </p>
                </div>
              </div>
            </div>
