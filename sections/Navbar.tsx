    ...
    <nav class="fixed z-50 bg-white w-full shadow-[0px_2px_4px_0px_rgba(0,_0,_0,_0.05),_0px_1px_10px_0px_rgba(0,_0,_0,_0.05),_0px_4px_5px_0px_rgba(0,_0,_0,_0.08)]">
      <div class="container px-[1rem]">
        ...
        <div class="flex  gap-4 py-4 lg:hidden">
          ...
          <label
            for="menu"
            class="flex justify-between items-center ml-2 cursor-pointer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
        ...
        <div class="content transform transition-all duration-300 ease-in-out max-h-0 peer-checked:max-h-96 overflow-hidden">
          <p class="text-sm text-black font-semibold border-t border-[#0000001a] py-3">
            Institucional
          </p>
          <p class="text-sm text-black font-semibold border-t border-[#0000001a] py-3">
            Graduação
                  ...
                  <li>
                    <div class="dropdown dropdown-hover p-0 bg-transparent rounded-md ">
                      <div
                        tabindex="0"
                        role="button"
                        class="btn text-xl font-bold text-black hover:text-white bg-transparent border-0 shadow-none m-1"
                      >
                        Institucional
                      </div>
                      <ul
                        tabindex="0"
                        class="dropdown-content z-[1] menu p-0 shadow-[0_2px_5px_0_rgba(0,_0,_0,_.16),_0_2px_10px_0_rgba(0,_0,_0,_.12)] bg-white rounded-[3px] min-w-52 top-full ml-1"
                      >
                        <li>
                          <a class="text-lg text-black font-semibold py-3 px-5">
                            Item 1
                          </a>
                        </li>
                        <li>
                    ...
                    <div class="dropdown dropdown-hover p-0 bg-transparent rounded-md ">
                      ...
                      >
                        <li>
                          <a
                            href="/graduacao"
                            class="text-lg text-black font-semibold py-3 px-5"
                          >
                            Nossos Cursos
                          </a>
                        </li>
