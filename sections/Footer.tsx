          ...
          <div class="flex flex-wrap md:gap-[15px]">
            <div class="flex-[1_1_auto] w-full md:w-auto md:max-w-[260px]">
              ...
              <ul class="px-3 md:px-0">
                <li>
                  <a
                    href=""
                    class="text-md font-base py-2 px-3 md:px-0 block bg-white border md:bg-transparent md:border-0"
                  >
            ...
            <div class="flex-[1_1_auto] w-full md:w-auto md:max-w-[260px]">
              ...
              <ul class="px-3 md:px-0">
                ...
                <li>
                  <h4 class="text-xl font-bold mt-3 px-3 md:px-0">
                    Portal do candidato:
                  </h4>
                </li>
                <li>
                  <a
                    href=""
                    class="text-md font-base py-2 px-3 md:px-0 block bg-white border md:bg-transparent md:border-0 flex leading-3 gap-[10px]"
                  >
                    EAD{" "}
                    <svg
            ...
            <div class="flex-[1_1_auto] w-full md:w-auto md:max-w-[260px]">
              <h4 class="text-2xl font-bold p-0">
              ...
              <img
                src="/e-mec.png"
                class="hidden md:block w-full max-w-[200px] mt-3"
                alt=""
              />
            </div>
            <div class="flex-[1_1_auto] w-full md:w-auto md:max-w-[260px]">
            ...
            <div class="flex items-center justify-end gap-[12px] flex-1">
              ...
              >
                ...
                >
                  <path
                    id="primary"
                    d="M0.42 0.18h0.09a0.03 0.03 0 0 0 0.03 -0.03V0.09a0.03 0.03 0 0 0 -0.03 -0.03h-0.09a0.15 0.15 0 0 0 -0.15 0.15v0.09H0.21a0.03 0.03 0 0 0 -0.03 0.03v0.06a0.03 0.03 0 0 0 0.03 0.03h0.06v0.21a0.03 0.03 0 0 0 0.03 0.03h0.06a0.03 0.03 0 0 0 0.03 -0.03v-0.21h0.067a0.03 0.03 0 0 0 0.03 -0.023l0.015 -0.06a0.03 0.03 0 0 0 -0.03 -0.037H0.39V0.21a0.03 0.03 0 0 1 0.03 -0.03"
                  >
                  </path>
                </svg>
              </a>
              ...
              <a
                href="https://twitter.com/UniasselviBR"
                target="_blank"
                class="social"
              >
                <svg
                ...
                >
                  <g clip-path="url(#clip0_2805_1812)">
                    ...
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M9.00159 4.59375H3.89062L9.95039 12.598L4.27828 19.3125H6.89897L11.189 14.2341L14.9984 19.2658H20.1094L13.8735 11.0289L13.8846 11.0431L19.2537 4.68722H16.633L12.6458 9.40725L9.00159 4.59375ZM6.7118 5.99555H8.30292L17.2882 17.864H15.6971L6.7118 5.99555Z"
                      fill="white"
                    >
                    </path>
                  </g>
