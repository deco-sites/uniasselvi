            ...
            <div class="container px-[1rem] py-10">
                {/* <div class="flex flex-col md:flex-row items-center gap-8"> */}
                    <div class="grid md:grid-cols-3 md:row-span-6 w-full md:gap-x-8">
                        <h2 class="md:col-start-1 md:col-span-2 md:order-1 text-xl md:lg:text-3xl lg:text-5xl text-black font-bold text-center md:text-left mb-6">Leo App</h2>
                        <p class="md:col-start-1 md:col-span-2 md:order-2 text-lg text-black font-semibold text-center md:text-left mb-6">Uma nova forma de aprender!</p>
                        ...
                        <p class="md:col-start-1 md:col-span-2 md:order-4 text-md text-black font-base text-center md:text-left">Muito mais benefícios no Leo App:</p>

                        <div class="md:col-start-1 md:col-span-2 md:order-5 flex flex-col md:flex-row gap-8 my-10">
                            <div class="flex-1 border border-black rounded-lg p-5">
                                <svg width="32px" height="32px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.667 10.667a7.333 7.333 0 1 1 11.461 6.063 12.007 12.007 0 0 1 7.867 10.907 1 1 0 0 1 -2 0.06 10 10 0 0 0 -19.991 0 1 1 0 0 1 -1.999 -0.059 12.007 12.007 0 0 1 7.867 -10.908A7.333 7.333 0 0 1 4.667 10.667M12 5.333a5.333 5.333 0 1 0 0 10.667 5.333 5.333 0 0 0 0 -10.667"></path><path d="M23.053 10.667q-0.295 0 -0.579 0.04a1 1 0 1 1 -0.283 -1.979 6.04 6.04 0 0 1 4.507 10.796 8.92 8.92 0 0 1 5.275 8.143 1 1 0 0 1 -2 0 6.92 6.92 0 0 0 -4.928 -6.629l-0.712 -0.213v-2.235l0.547 -0.279A4.04 4.04 0 0 0 23.053 10.667"></path></svg>
                                <p class="text-lg text-black mt-2">Atendimento humano focado no que é melhor para você!</p>
                            </div>
                            <div class="flex-1 border border-black rounded-lg p-5">
                                <svg fill="#000000" width="32px" height="32px" viewBox="0 0 0.96 0.96" xmlns="http://www.w3.org/2000/svg"><path d="M0.232 0.602a0.02 0.02 0 0 1 0.016 0.002 0.26 0.26 0 1 0 -0.091 -0.091 0.02 0.02 0 0 1 0.002 0.016l-0.029 0.102zm0.436 -0.309a0.3 0.3 0 0 1 0.175 0.433l0.037 0.129a0.02 0.02 0 0 1 -0.025 0.025l-0.129 -0.037a0.3 0.3 0 0 1 -0.433 -0.175 0.3 0.3 0 0 1 -0.058 -0.025l-0.129 0.037a0.02 0.02 0 0 1 -0.025 -0.025l0.037 -0.129a0.3 0.3 0 1 1 0.55 -0.233m0.01 0.046Q0.68 0.359 0.68 0.38a0.3 0.3 0 0 1 -0.341 0.297 0.26 0.26 0 0 0 0.374 0.126 0.02 0.02 0 0 1 0.016 -0.002l0.102 0.029 -0.029 -0.102a0.02 0.02 0 0 1 0.002 -0.016A0.26 0.26 0 0 0 0.677 0.339"></path></svg>
                                <p class="text-lg text-black mt-2">Tire dúvidas com seus tutores online e sem burocracia.</p>
                            </div>
                            <div class="flex-1 border border-black rounded-lg p-5">
                                <svg width="32px" height="32px" viewBox="0 0 40.96 40.96" class="icon" xmlns="http://www.w3.org/2000/svg"><path fill="#000000" d="M28.16 30.72V10.24H5.12v20.48zm2.56 -16.64 7.68 -3.84v20.48l-7.68 -3.84v5.12a1.28 1.28 0 0 1 -1.28 1.28H3.84a1.28 1.28 0 0 1 -1.28 -1.28V8.96a1.28 1.28 0 0 1 1.28 -1.28h25.6a1.28 1.28 0 0 1 1.28 1.28zm0 2.862v7.076l5.12 2.56V14.382zM7.68 12.8h7.68v2.56H7.68z"></path></svg>
                                <p class="text-lg text-black mt-2">Acesse a biblioteca virtual e sua grade curricular.</p>
                            </div>
                        </div>
            
                        <p class="md:col-start-1 md:col-span-2 md:order-6 text-lg text-black font-semibold text-center md:text-left mb-6">Experiência fluida e você não paga pelos dados usados nele!</p>

                        <div class="md:col-start-1 md:col-span-2 md:order-7 flex justify-center gap-2 md:gap-8">
                            <a href="" class="flex items-center gap-4 md:gap-7 bg-black py-2 px-2 md:px-5 w-fit md:w-[211px] rounded">
