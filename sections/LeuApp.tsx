        ...
        <section class="bg-[linear-gradient(157deg,_rgba(244,244,244,1)_0%,_rgba(244,244,244,1)_77%,_rgba(254,223,17,1)_77%,_rgba(255,221,0,1)_100%)]">
            <div class="container px-[1rem] py-10">
                <div class="flex flex-col md:flex-row items-center gap-8">
                    <div class="flex-[1_1_auto] w-full md:w-[60%]">
                        <h2 class="text-5xl text-black font-bold mb-6">Leo App</h2>
                        <p class="text-lg text-black font-semibold mb-6">Uma nova forma de aprender!</p>
                        <p class="text-md text-black font-base">Muito mais benefícios no Leo App:</p>
                        ...
                        <p class="text-lg text-black font-semibold mb-6">Experiência fluida e você não paga pelos dados usados nele!</p>
                    ...
                    <div class="flex-[1_1_auto] w-full md:w-[30%]">
                        {image && (
                            <Image
                                class="block w-full"
                                src={image || ""}
