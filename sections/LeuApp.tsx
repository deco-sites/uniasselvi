                    ...
                    <div class="grid md:grid-cols-3 md:row-span-6 w-full md:gap-x-8">
                        ...
                        <div class="md:col-start-1 md:col-span-2 md:order-5 flex gap-3 md:gap-8 my-10 overflow-x-auto md:overflow-x-visible">
                            <div class="min-w-[175px] md:min-w-0 md:flex-1 border border-black rounded-lg p-2 md:p-5">
                                ...
                                <p class="text-sm md:text-lg text-black mt-2">Atendimento humano focado no que é melhor para você!</p>
                            </div>
                            <div class="min-w-[175px] md:min-w-0 md:flex-1 border border-black rounded-lg p-2 md:p-5">
                                ...
                                <p class="text-sm md:text-lg text-black mt-2">Tire dúvidas com seus tutores online e sem burocracia.</p>
                            </div>
                            <div class="min-w-[175px] md:min-w-0 md:flex-1 border border-black rounded-lg p-2 md:p-5">
                                ...
                                <p class="text-sm md:text-lg text-black mt-2">Acesse a biblioteca virtual e sua grade curricular.</p>
                            </div>
                        </div>
