...
const Form = ({ active_index, image }: FormProps) => {
  ...
  const submit = async (e: Event) => {
    ...
    try {
      const response = await invoke.site.actions.CreateSelectionExam({
        dataToSend,
      });
      ...
      if (result && result.studentId) {
        ...
        if (data.value.cpf && data.value.data_nasc) {
          setTimeout(async () => {
            const token = await invoke.site.actions.getTokenAva({
              cpf: data.value.cpf,
  ...
  const formIsValid = () => {
    ...
    Object.keys(keys_length).forEach(function (key, length) {
      if (
        !data.value[key as keyof typeof data.value] ||
        (data.value[key as keyof typeof data.value].length < length)
      ) {
        errors.value = {
          ...errors.value,
          [key]: true,
    ...
    <div>
      ...
      {etapaForm.value == 1 && (
        <div class="text-center">
          <p class="text-3xl font-base text-black">
            Agora falta pouco para concluir sua inscrição em{" "}
            <span class="text-[#00a59a] font-bold">[Administração]</span>{" "}
            na UNIASSELVI.
          </p>
          <p class="text-xl font-base text-black mt-[40px]">
            Selecione sua <strong>forma de ingresso</strong>{" "}
            e preencha as informações abaixo para dar o próximo grande passo na
            sua carreira:
          </p>
          <div class="flex flex-col md:flex-row justify-center flex-wrap gap-[15px] my-10">
            <a
              ...
              class="md:flex-[0_0_190px] bg-[#ededed] grid md:grid-rows-[auto_1fr_auto] justify-center p-4"
            >
            ...
            <div class="md:flex-[0_0_190px] bg-[#ededed] grid md:grid-rows-[auto_1fr_auto] justify-center p-4">
              ...
              <div>
                ...
                <p class="hidden md:block text-sm leading-5">
                  Se você fez o ENEM, <strong>utilize sua nota</strong>{" "}
                  e ingresse sem realizar a prova.
                </p>
              </div>
              <button class="hidden md:block bg-[#ffef98] mt-4 rounded-md shadow-[0_6px_8px_0_rgba(73,73,73,.36)] text-lg font-semibold w-full py-3 px-5">
                Continuar
              </button>
            </div>
            <div class="md:flex-[0_0_190px] bg-[#ededed] grid md:grid-rows-[auto_1fr_auto] justify-center p-4">
              ...
              <div>
                ...
                <p class="hidden md:block text-sm leading-5">
                  Se você fez o ENCCEJA, <strong>utilize sua nota</strong>{" "}
                  e ingresse realizando uma <b>prova simples</b>{" "}
                  (Vestibular On-line).
                </p>
              </div>
              <button class="hidden md:block bg-[#ffef98] mt-4 rounded-md shadow-[0_6px_8px_0_rgba(73,73,73,.36)] text-lg font-semibold w-full py-3 px-5">
              ...
              <div class="hidden md:flex justify-center mb-4">
                ...
                >
                  <path
                    fill="#3b3c3a"
                    fill-rule="evenodd"
                    d="M1303,6298.01a8,8,0,0,0-8,7.99,7.885,7.885,0,0,0,2.01,5.24V6324l6.01-4,5.99,4v-12.76A7.955,7.955,0,0,0,1303,6298.01Zm2.01,17.99h-4v-2.28a7.726,7.726,0,0,0,2,.28,7.927,7.927,0,0,0,2.01-.28V6316h-0.01Zm-2.01-6a4,4,0,1,1,4-4A4,4,0,0,1,1303,6310Zm0-26v12h0a9.96,9.96,0,0,1,8,15.96V6318h24v-34h-32Zm28,24h-13.99v-4H1331v4Zm0-8h-13.99v-4H1331v4Zm0-8h-24v-4h24v4Z"
                    transform="translate(-1295 -6284)"
                  />
                </svg>
              </div>
              <div>
                ...
                <p class="hidden md:block text-sm leading-5">
                  Se você <strong>já possui</strong>{" "}
                  uma graduação, ingresse sem realizar a prova.
                </p>
              </div>
              <button class="hidden md:block bg-[#ffef98] mt-4 rounded-md shadow-[0_6px_8px_0_rgba(73,73,73,.36)] text-lg font-semibold w-full py-3 px-5">
                Continuar
              ...
              <div class="hidden md:flex justify-center mb-4">
                ...
                >
                  <path
                    fill="#3b3c3a"
                    fill-rule="evenodd"
                    d="M1548.05,6327.54c-0.8-.81-1.82-1.83-2.25-2.28l-0.78-.83,2.27-2.22c1.25-1.23,2.25-2.25,2.23-2.27s-5.11-.05-11.29-0.05H1527v-6.3h11.23c6.18,0,11.26-.02,11.29-0.04s-0.98-1.05-2.23-2.28l-2.27-2.22,1.17-1.2c0.65-.65,1.67-1.67,2.27-2.26l1.1-1.07,6.19,6.06c4.08,4,6.18,6.11,6.18,6.19s-2.09,2.19-6.17,6.18c-3.39,3.33-6.18,6.05-6.2,6.05s-0.7-.66-1.51-1.46h0Zm-14.81-29.1c-4.07-3.99-6.17-6.09-6.17-6.18s2.11-2.2,6.18-6.2l6.19-6.06,1.1,1.07c0.6,0.59,1.62,1.61,2.27,2.27l1.17,1.19-2.27,2.23c-1.25,1.22-2.25,2.24-2.23,2.27s5.11,0.05,11.29.05H1562v6.29h-11.23c-6.18,0-11.26.02-11.29,0.05s0.98,1.05,2.23,2.27l2.27,2.23-0.78.82c-0.93.98-3.7,3.74-3.76,3.74-0.02,0-2.81-2.72-6.2-6.04h0Z"
                    transform="translate(-1527 -6280)"
                  />
                </svg>
              </div>
              <div>
                ...
                <p class="hidden md:block text-sm leading-5">
                  Faça a sua transferência e convalide disciplinas de outra
                  instituição.
                </p>
              </div>
              <button class="hidden md:block bg-[#ffef98] mt-4 rounded-md shadow-[0_6px_8px_0_rgba(73,73,73,.36)] text-lg font-semibold w-full py-3 px-5">
      ...
      {mostrarForm.value && (
        <div id="form" class="pt-14">
          <div class="grid grid-cols-3 mb-8">
            <div
              class={`bar ${etapaForm.value > 1 ? "bar-completed" : ""} ${
                etapaForm.value == 1 ? "bar-active" : ""
              }`}
            >
              <strong>
                1
              ...
              <span class="hidden md:block">
                Dados do candidato {etapaForm.value}
              </span>
            </div>
            <div
              class={`bar ${etapaForm.value > 2 ? "bar-completed" : ""} ${
                etapaForm.value == 2 ? "bar-active" : ""
              }`}
            >
              <strong>
                2
              ...
              <div className="container">
                <div class="flex justify-between ">
                  <div class="flex">
                    ...
                    <div class="ml-4">
                      <span class="text-xl lg:text-4xl font-base">
                        Preencha seus dados
                      </span>
                      <br></br>
                      <span>
                ...
                <div class="grid grid-cols-12 gap-[20px] my-[50px]">
                  ...
                  <div class="order-2 md:order-2 col-span-12">
                    ...
                    />
                    {errors.value.email && (
                      <p class="text-red-500">email é obrigatório</p>
                    )}
                  </div>
                  ...
                  <div class="order-4 md:order-4 col-span-12 md:col-span-6 p-3 border border-black rounded-lg">
                    ...
                    <div className="flex items-center gap-[15px]">
                      ...
                      <label htmlFor="whatsapp">
                        Autorizo o uso do WhatsApp no telefone informado
                      </label>
                    </div>
                  </div>
                  <div class="order-4 md:order-4 col-span-12 p-3 border border-black rounded-lg flex gap-[15px]">
                    ...
                    <label htmlFor="politica">
                      Li e aceito a{" "}
                      <a href="" class="underline color-blue">
                        Política de Privacidade.
                      </a>{" "}
                      Autorizo a coleta e o tratamento de meus dados pessoais
                      pela UNIASSELVI, seu grupo econômico, instituições de
                      ensino e parceiros.
                    </label>
                  </div>
                  <div class="order-6 md:order-5 col-span-12 md:col-span-5 flex justify-center md:block">
                    <button
                      type="button"
                      class="w-fit md:w-full bg-[#f0f0f0] py-3 px-5 rounded-lg shadow-[0_6px_8px_0_rgba(73,73,73,.36)]"
                    >
                      Voltar aos cursos
                    </button>
                  </div>
                  <div class="order-5 md:order-6 col-span-12 md:col-span-7">
                    <button
                      ...
                      class="w-full bg-[#ffdb1a] py-3 px-5 rounded-lg shadow-[0_6px_8px_0_rgba(73,73,73,.36)]"
                    >
                ...
                <div className="flex justify-between">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <br></br>
                      <span>
                        Digite seus dados no formulário abaixo e garanta sua
                        {" "}
                  ...
                  <div class="col-span-12 md:col-span-4">
                    ...
                    <input
                      ...
                      onInput={(e) => {
                        ...
                        if (
                          cpf.replaceAll(".", "").replaceAll("-", "").length ===
                            11
                        ) {
                          handleCpfBlur();
                        }
                    ...
                    />
                    {errors.value.cpf && (
                      <p class="text-red-500">Cpf Inválido</p>
                    )}
                  </div>
                </div>
                  ...
                  <div class="col-span-12 md:col-span-4">
                    ...
                    <label class="radio-container">
                      ...
                      <input
                        ...
                        name="sexo"
                        value="M"
                        checked={data.value.sexo === "M"}
                        onClick={(e) => data.value.sexo = "M"}
                      />
                    ...
                    <label class="radio-container">
                      ...
                      <input
                        ...
                        name="sexo"
                        value="F"
                        checked={data.value.sexo === "F"}
                        onClick={(e) => data.value.sexo = "F"}
                      />
                      <span class="checkmark"></span>
                    </label>
                    {errors.value.sexo && (
                      <p class="text-red-500">Sexo é obrigatório</p>
                    )}
                  </div>
                  <div class="col-span-12 md:col-span-4">
                    <label for="cpf" class="text-base font-bold block">
                    ...
                    <input
                      ...
                      class="border p-2 rounded w-full"
                    />
                    {errors.value.nacionalidade && (
                      <p class="text-red-500">Nacionalidade é obrigatório</p>
                    )}
                  </div>
                  <div class="col-span-12 md:col-span-4">
                    <label for="cpf" class="text-base font-bold block">
                    ...
                    <input
                      ...
                      onInput={(e) =>
                        handleChange(
                          e,
                          formatDate(e.currentTarget.value) as string,
                        )}
                      class="border p-2 rounded w-full"
                      placeholder="__/__/____"
                      maxLength={10}
                    />
                    {errors.value.data_nasc && (
                      <p class="text-red-500">Data de nascimento inválida</p>
                    )}
                  </div>
                </div>
                <div class="grid grid-cols-12 gap-4 mt-5 md:mt-10">
                  <div class="col-span-12 md:col-span-5">
                    ...
                    />
                    {errors.value.cep && (
                      <p class="text-red-500">CEP inválido</p>
                    )}
                    <small>
                  ...
                  <div class="col-span-6 flex justify-end items-center underline">
                    <a
                      ...
                      class="link-cep"
                    >
                      Não sabe seu CEP? <b>Consulte Aqui</b>
                    </a>
                  </div>
                </div>
                <div class="grid grid-cols-12 gap-4 mt-10">
                  <div class="col-span-12 md:col-span-5">
                    ...
                    {errors.value.endereco && (
                      <p class="text-red-500">Endereço é obrigatório</p>
                    )}
                  </div>
                  <div class="col-span-12 md:col-span-2">
                    ...
                    />
                    {errors.value.numero && (
                      <p class="text-red-500">Número é obrigatório</p>
                    )}
                  </div>
                  ...
                  <div class="col-span-12 md:col-span-5">
                    ...
                    />
                    {errors.value.bairro && (
                      <p class="text-red-500">Bairro é obrigatório</p>
                    )}
                  </div>
                </div>
                <div class="grid grid-cols-12 gap-4 mt-5 md:mt-10">
                  ...
                  <div class="col-span-12 md:col-span-4">
                    ...
                    />
                    {errors.value.cidade && (
                      <p class="text-red-500">Cidade é obrigatória</p>
                    )}
                  </div>
                  <div class="col-span-12 md:col-span-4">
                    <label for="cpf" class="text-base font-bold block">
                    ...
                    />
                    {errors.value.estado && (
                      <p class="text-red-500">Estado é obrigatório</p>
                    )}
                  </div>
                </div>
                <div class="grid grid-cols-12 gap-4 mt-10">
                  <div class="col-span-12 md:col-span-3">
                    ...
                    <small class="font-extralight block mt-3">
                      Encontros presenciais 1 vez por semana com um tutor para
                  ...
                  <div class="col-span-12 md:col-span-3">
                    ...
                    <label class="radio-container">
                      ...
                      <input
                        ...
                        name="possui_medio"
                        value="S"
                        checked={data.value.possui_medio === "S"}
                        onClick={(e) => {
                          data.value = {
                            ...data.value,
                            possui_medio: "S",
                    ...
                    <label class="radio-container">
                      ...
                      <input
                        ...
                        name="possui_medio"
                        value="N"
                        checked={data.value.possui_medio === "N"}
                        onClick={(e) => {
                          data.value = {
                            ...data.value,
                            possui_medio: "N",
      ...
      {etapaForm.value === 3 && (
        <section class="relative overflow-hidden px-[1rem]">
          ...
          <div class="absolute top-0 w-full h-full h-full flex container gap-[24px] relative px-10 py-[60px] md:py-[150px] md:px-[200px]">
            <div class="text-center">
              <p class="text-[#ffdd00] uppercase text-[27px]">
                <strong>Inscrição Realizada com Sucesso!</strong>
              </p>
              <p class="text-white text-lg my-6">
                <strong>Parabéns!</strong>{" "}
                Agora, a sua matrícula pode ser feita diretamente pelo nosso
                aplicativo Leo App:
              </p>
              <div class="flex flex-col md:flex-row gap-8 justify-center">
                <a
                  href=""
                  class="flex items-center gap-7 bg-black py-2 px-5 w-fit"
                >
                  <svg
                    class="block"
                    width="21px"
              ...
              <p class="text-white text-lg my-6">
                Assim que você instalar o nosso aplicativo, você não gasta mais
                seu pacote de dados para utilizar o Leo App. Além de realizar
                sua matricula, este é o aplicativo que você vai utilizar em seus
                estudos.
              </p>
              <p class="text-white text-lg my-6">
                Caso você tenha alguma dificuldade, ou precise tirar alguma
                dúvida sobre a sua matrícula não hesite em entrar em contato
                conosco através do WhatsApp, <a href="#">clicando aqui</a>.
              </p>
            </div>
          </div>
        </section>
